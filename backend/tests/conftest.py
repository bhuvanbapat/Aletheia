...
The app engine binds to SENTINELOPS_DATABASE_URL at import time, so the URL
...
os.environ["SENTINELOPS_DATABASE_URL"] = f"sqlite:///{os.path.join(_test_dir, _db_name)}"
